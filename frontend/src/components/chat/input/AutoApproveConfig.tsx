...
interface AutoApproveConfigProps {
 ...
 */
const AutoApproveConfig = ({ onSettingsChange }: AutoApproveConfigProps) => {
  // 本地状态管理
  ...
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (isExpanded && !(e.target as HTMLElement).closest('.auto-approve-container')) {
        setIsExpanded(false);
      }
    };
